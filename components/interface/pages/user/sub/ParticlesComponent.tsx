...
const ParticlesComponent: React.FC<ParticlesComponentProps> = ({colors}) => {
    // Default colors
    const defaultColors = ["rgb(29, 20, 48)", "rgb(104, 195, 239)", "rgb(200, 163, 116)"];
    ...
    return (
        <div style={{ width: "320px", height: "320px", position: "absolute", zIndex: -1, filter:"blur(60px)", top:"50%", right:"128px", transform:"translate(0, -50%)"}}>
            <Particles
                id="tsparticles"
                init={particlesInit}
