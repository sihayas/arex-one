...
export function SignalsIcon({ ...props }) {
  return (
    ...
    >
      <path
        fill="#CCC"
        d="M7.371 9.055c.28-1.097.572-2.2.879-3.31.119-.43.307-.493.748-.494l2.363-.007c.395-.002.607.171.636.52.04.47-.34.613-.756.612-.651-.002-1.303-.002-1.954.002-.032 0-.052.016-.06.047-.455 1.715-.912 3.428-1.37 5.14-.085.32-.366.504-.69.41-.22-.063-.363-.236-.431-.518L4.662 2.856a.022.022 0 0 0-.044-.001l-.872 3.051c-.104.361-.287.467-.668.468-.83.002-1.66-.004-2.489-.017C.2 6.351.003 6.17 0 5.814c-.004-.476.386-.565.801-.563.639.002 1.277.002 1.914-.002.032 0 .052-.016.06-.046.454-1.58.904-3.157 1.353-4.733.096-.339.357-.55.71-.44.215.065.356.239.423.52l2.052 8.505a.03.03 0 0 0 .058 0Z"
      />
    </svg>
  );
}
...
export function IndexIcon({ ...props }) {
  return (
    ...
    >
      <path
        fill="#CCC"
        d="M3.433.068c.393.179.417.717.092.954-.097.071-.259.108-.484.11-.933.009-1.907-.178-1.91 1.099 0 .457.184 1.56-.584 1.522-.343-.017-.518-.212-.523-.586-.01-.536-.075-1.164.063-1.643C.29.824.73.358 1.41.125c.528-.18 1.25-.113 1.85-.111.035 0 .092.018.173.054ZM8.447 1.01c-.353-.254-.225-.915.26-.985.213-.03.598-.033 1.153-.009.96.041 1.71.48 2.02 1.415.173.522.11 1.253.1 1.85a.429.429 0 0 1-.208.366c-.28.186-.687.121-.839-.192-.048-.099-.07-.262-.069-.488.002-.443.068-1.028-.134-1.373-.35-.605-1.137-.458-1.72-.458-.257 0-.445-.042-.563-.126ZM7.648 8.506c-.835.492-1.67.61-2.503.354C3.3 8.292 2.401 6.165 3.427 4.469c1.221-2.018 4.105-1.921 5.22.139.434.801.462 1.678.084 2.63-.046.116-.167.264-.223.409a.071.071 0 0 0 .018.083 479.87 479.87 0 0 1 1.696 1.693c.158.158.248.304.27.437.085.532-.596.827-.996.425a396.589 396.589 0 0 0-1.77-1.77c-.024-.023-.05-.026-.078-.01Zm.222-2.509A1.868 1.868 0 0 0 6 4.128a1.873 1.873 0 0 0-1.872 1.87A1.868 1.868 0 0 0 6 7.866a1.873 1.873 0 0 0 1.871-1.87ZM1.537 10.686c.348.237 1.002.188 1.405.172.235-.009.399.006.491.043.39.158.42.781.079.982-.285.17-1.546.12-1.872.042-.807-.194-1.325-.681-1.551-1.462C-.047 9.99.015 9.355.009 8.82 0 8.214.812 8.006 1.071 8.545c.121.253.061.815.06 1.106-.002.477.032.78.405 1.035Z"
      />
    </svg>
  );
}
