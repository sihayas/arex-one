...
export function SettingsIcon({ ...props }) {
  return (
    ...
    >
      <path
        fill="#000"
        d="M11.327 15.033h-6.4a1.48 1.48 0 0 1-1.276-.737L.45 8.754a1.477 1.477 0 0 1 0-1.474l3.2-5.543A1.478 1.478 0 0 1 4.927 1h6.4a1.479 1.479 0 0 1 1.277.737l3.2 5.543a1.478 1.478 0 0 1 0 1.473l-3.2 5.543a1.478 1.478 0 0 1-1.277.737Zm-6.4-12.891a.332.332 0 0 0-.287.166L1.44 7.85a.331.331 0 0 0 0 .332l3.2 5.542a.332.332 0 0 0 .287.166h6.4a.332.332 0 0 0 .288-.167l3.2-5.542a.331.331 0 0 0 0-.331l-3.2-5.542a.33.33 0 0 0-.287-.166h-6.4Z"
      />
      <path
        fill="#000"
        d="M8.127 10.926a2.908 2.908 0 1 1 0-5.816 2.908 2.908 0 0 1 0 5.816Zm0-4.674a1.766 1.766 0 1 0 0 3.531 1.766 1.766 0 0 0 0-3.53Z"
      />
    </svg>
  );
}
