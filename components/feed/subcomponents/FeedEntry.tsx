...
export const FeedEntry: React.FC<EntryProps> = ({ review }) => {
  ...
  return (
    <div className="flex">
      <p className="text-[#3C3C43]/90 font-medium text-sm leading-[75%] translate-y-[358px] mr-2 text-end min-w-[126px]">
        {review.author.name}
      </p>
      <UserAvatar
        className="w-10 h-10 translate-y-[343px] outline outline-[.5px] outline-silver mr-2"
      ...
      <div className="flex flex-col max-w-[358px] bg-[#F4F4F4] rounded-[13px] relative p-4">
        {/* Artwork */}
        <Artwork album={album} />
        {/* Rating & Sound Names */}
        <Stars
          className={`absolute top-[310px] -left-[13px] shadow-stars outline outline-silver outline-[.5px] pr-2`}
